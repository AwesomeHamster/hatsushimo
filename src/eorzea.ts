...
export async function apply(context: Context, _config: EorzeaOptions = {}): Promise<void> {
  let koishiEorzeaTimeInterface = eorzeaContainer.get<KoishiEorzeaTimeSerivce>(
    EorzeaTimeTypes.KoishiEorzeaTimeInterface,
  );
  let koishiEorzeaItemInterface = eorzeaContainer.get<KoishiEorzeaItemSerivce>(
    EorzeaItemTypes.KoishiEorzeaItemInterface,
  );
